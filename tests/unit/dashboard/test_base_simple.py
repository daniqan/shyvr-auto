"""
Simple tests for dashboard base models and data structures that don't require full config
"""
...
# Import the specific classes we need without importing the full dashboard module
from src.dashboard.base import (
    SystemMetrics, TradingStatus, PortfolioStatus, MLRLStatus,
