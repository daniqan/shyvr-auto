...
class TestDataClasses:
    ...
    def test_token_info_creation(self):
        ...
        token = TokenInfo(
            address="0x123", symbol="TEST", name="Test Token", chain=Chain.ETHEREUM, decimals=18
        )
    ...
    def test_agent_rule_defaults(self):
        ...
        rule = AgentRule(
            id="rule-2", prompt_text="Test rule", rule_type="filter", parsed_conditions={}
        )
    ...
    def test_evaluator_implementation(self):
        ...
        class TestEvaluator(Evaluator):
            async def evaluate_fundamentals(self, token: TokenInfo):
                return {"liquidity": 10000, "holders": 100, "risk_score": 0.3}
    ...
    def test_ml_analyzer_implementation(self):
        ...
        class TestMLAnalyzer(MLAnalyzer):
            ...
            async def calculate_features(self, token: TokenInfo):
                return {"current_price": 0.00123, "volume_24h": 50000, "market_cap": 1000000}
