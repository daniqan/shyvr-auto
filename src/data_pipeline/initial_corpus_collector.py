        ...
        try:
            ...
            async with get_database_connection() as conn:
                ...
                metadata = {
                    ...
                    'start_date': version_info['start_timestamp'].isoformat() if version_info['start_timestamp'] else None,
                    'end_date': version_info['end_timestamp'].isoformat() if version_info['end_timestamp'] else None,
